      ...
      <div className="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {taskStatus.map((status) => (
          <TaskColumn
            ...
            tasks={tasks || []}
            moveTask={moveTask}
            setIsModalNewTaskOpen={setIsNewTaskOpen}
          />
        ))}
      </div>
    </DndProvider>
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://jira-pm-s3-images.s3.ap-northeast-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://jira-pm-s3-images.s3.ap-northeast-1.amazonaws.com/${task.author.profilePictureUrl!}`}
