  ...
  return (
    <div className={sidebarClassNames}>
      <div className="flex-h-[100%] w-full flex-col justify-start">
        ...
        {/* Projects Links */}
        <button onClick={setShowProjects}
          className="flex w-full items-center justify-between px-7 py-3 text-gray-500"
          >
            <span>Projects</span>
          <ChevronUp className={`size-5 transition-transform ${showProjects && "rotate-180"}`} />
        </button>

       

        {/* Prioritity Links */}
        <button onClick={setShowPriority}
          className="flex w-full items-center justify-between px-7 py-3 text-gray-500"
          >
            <span>Priorities</span>
          <ChevronUp className={`size-5 transition-transform ${showPriority && "rotate-180"}`} />
        </button>
...
const SidebarLink = ({
  ...
  return (
    <Link href={href} className="w-full">
      <div className={`relative flex items-center cursor-pointer gap-3 transition-colors
